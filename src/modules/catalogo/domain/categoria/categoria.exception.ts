...
class NomeCategoriaTamanhoMinimoInvalido extends CategoriaException {
    constructor(message: string = "O nome da categoria deve ter no mínimo 4 caracteres") {
        super(message);
...
class NomeCategoriaTamanhoMaximoInvalido extends CategoriaException {
    constructor(message: string = "O nome da categoria deve ter no máximo 50 caracteres") {
        super(message);
...
export { CategoriaException, NomeCategoriaNuloOuIndefinido, NomeCategoriaTamanhoMinimoInvalido, NomeCategoriaTamanhoMaximoInvalido };